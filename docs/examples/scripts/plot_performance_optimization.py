...
start = time.time()
regridder = Regridder(ds, target_grid, method="bilinear", filename=weights_file, reuse_weights=True)
_ = regridder(ds.air)
...
start = time.time()
regridder_cached = Regridder(ds, target_grid, method="bilinear", filename=weights_file, reuse_weights=True)
